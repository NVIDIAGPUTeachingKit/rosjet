...
#if defined (__AVR_ATmega2560__) // Use Timer4 for ATmega2560 (Arduino Mega).
...
void NewPing::timer_setup() {
	...
	TCCR4A = TCCR4C = 0;
	TCCR4B = (1<<WGM42) | (1<<CS41) | (1<<CS40); // Set Timer4 prescaler to 64 (4uS/count, 4uS-1020uS range).
	TCNT4 = 0;           // Reset Timer2 counter.
#elif defined (__AVR_ATmega32U4__) // Use Timer4 for ATmega32U4 (Teensy/Leonardo).
